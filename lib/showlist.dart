...
//   });
//   var ownuserId = _HomeScreenState().ownuserId;
//   @override
//   Widget build(BuildContext context) {
//     return Padding(
...
//                   ));
//                  // ownuserId == userId ? Navigator.push(context, MaterialPageRoute(builder: (context) => const ProfileView())) : Navigator.push(context, MaterialPageRoute(builder: (context) => OtherProfile(userId: userId)));
